...
const resources = {
  en: {
    translation: {
      ...
      storagePermission: 'Storage permission is required to pick an image.'
    }
  },
  ru: {
    translation: {
      ...
      registrationError: 'Не удалось зарегистрироваться. Повторите попытку.',
      invalidEmail: 'Введите корректный адрес эл. почты',
      permission: 'Разрешение',
      storagePermission: 'Для выбора изображения требуется доступ к хранилищу.'
    }
  }
};
